...
class ViewController: UIViewController {
    ...
    let imgOn = UIImage(named:"1.jpeg")
    let imgOff = UIImage(named:"2.jpeg")
    ...
    @IBAction func btnLampRemove(_ sender: UIButton) {
        ...
        let removeAction = UIAlertAction(title: "네, 제거합니다(remove)", style: UIAlertAction.Style.default, handler: {ACTION in self.lampImg.image = self.imgRemove
            self.isLampOn = false})
